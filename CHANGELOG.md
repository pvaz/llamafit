...
- Design specification covering host detection, llama.cpp integration, the model catalog,
  ...
  and web dashboard, the installer, and the verifier (`docs/superpowers/specs/`).
- Implementation plan for phase 1A, foundation and host scan (`docs/superpowers/plans/`).
