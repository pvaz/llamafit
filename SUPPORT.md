...
## Something does not work on your machine?

Run this and paste the output into a bug report, removing anything you consider private,
such as paths with your name:
...
## A model is missing, or its data is wrong

Open a *Model request* issue. The catalog is curated by hand from primary sources, and
corrections with a link to the source are merged quickly.

## A question rather than a bug

Use GitHub Discussions on this repository. Questions about llama.cpp itself, such as build
flags or model conversion, are better asked in the llama.cpp project.
